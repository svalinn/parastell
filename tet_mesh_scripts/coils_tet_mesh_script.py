...
# Import coils
coils_path = "/home/eitan-weinstein/cubit/files_and_outputs/py/magnet_coils.step"
...
for coil_num in np.arange(1,49):
    ...
    log_path = f"/home/eitan-weinstein/cubit/files_and_outputs/log/coils/coils_log_{coil_num}.log"
    ...
    exo_path = f"/home/eitan-weinstein/cubit/files_and_outputs/exo/coils/coils_tet_mesh_{coil_num}.exo"
    cubit.cmd(f'export mesh "{exo_path}"')

    # Convert to h5m
    h5m_path = f"/home/eitan-weinstein/cubit/files_and_outputs/h5m/coils/coils_tet_mesh_{coil_num}.h5m"
